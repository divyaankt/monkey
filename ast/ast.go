...
type Node interface {
	...
	String() string       //String representation of node for easier debugging
}
...
//Call Expression can be in the following form
//add(2, 3)
//add(2 + 2, 3 * 3 * 3)
//fn(x, y) { x + y; }(2, 3)
...
type HashLiteral struct {
	Token token.Token //the "{" token
	//The key of the Hash can either be a string, integer or boolean
